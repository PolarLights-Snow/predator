...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "gimljysorpy0en9j"    //开发平台创建产品后生成的16位字符产品唯一标识
...
#define CONFIG_MODE_DELAY_TIME    4         //配网模式打开时间 单位:分钟
...
extern  unsigned char Flag_ZD_KG;				//自动喂食开关状态标志位
extern  unsigned char Flag_WS_ZT;				//喂食状态
extern  unsigned long Flag_YL_LT;				//粮桶余量
extern  unsigned long Flag_YL_SW;				//余量
/**
 * @brief  串口发送数据
